    ...
    <div className="pb-20 min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <Bookmark className="h-6 w-6 text-[#3FDBED]" />
        </div>
        ...
        <div className="space-y-4">
          ...
          {isAdmin && (
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                              <div className="w-10 h-10 bg-[#D9F8FB] rounded-full flex items-center justify-center">
              <Shield className="h-5 w-5 text-[#3FDBED]" />
            </div>
                  <div>
